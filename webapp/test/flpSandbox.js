					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#purchaseorder1-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"purchaseorder1-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=purchaseorder1",
									"url": sap.ui.require.toUrl("purchaseorder1")
								}
							}
						}
					}
